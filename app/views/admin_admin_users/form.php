		...
		<form class="form-horizontal" method="post" action="<?php echo $current_page ; ?>" role="form">
			<div class="form-group">
				...
				<div class="col-lg-4 col-md-8">
					<input type="text" required name="firstname" class="form-control" id="firstname" placeholder="Prénom" value="<?php echo (isset($item->firstname)) ? $item->firstname : '' ; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="name" class="col-md-2 control-label">Nom</label>
				<div class="col-lg-4 col-md-8">
					<input type="text" required name="name" class="form-control" id="name" placeholder="Nom" value="<?php echo (isset($item->name)) ? $item->name : '' ; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="mail" class="col-md-2 control-label">E-Mail</label>
				<div class="col-lg-4 col-md-8">
					<input type="email" required name="mail" class="form-control" id="mail" placeholder="E-Mail" value="<?php echo (isset($item->mail)) ? $item->mail : '' ; ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4 col-md-8">
					<?php if($_SESSION['ADMIN-USER']['statut'] == 1){ ?>
					...
					?>
					<p class="form-control-static"><?php echo $item->statut ; ?></p>
					<?php } ?>
				</div>
			</div>
