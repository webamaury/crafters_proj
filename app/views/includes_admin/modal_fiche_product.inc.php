<div class="modal fade modal_fiche_product" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel">Details about <span class="ajax_name"></span></h4>
			</div>
				...
				<div class="col-md-7">
					<form class="form-horizontal" method="post" action="#" role="form">
						...
						<div class="display-inline">
							...
							<div class="col-md-8">
								<p class="form-control-static ajax_description"></p>
							</div>
						</div>
						<div class="display-inline">
