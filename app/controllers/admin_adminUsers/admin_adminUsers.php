    ...
    function __construct($arrayTools, $notices, $modules)
    {
        ...
        if (isset($_GET['action']) && $_GET['action'] === "delete") {
            ...
            if (isset($_POST['action']) && $_POST['action'] === 'send_mail') {
                ...
                if ($this->send_mail($tpl, $_SESSION['ADMIN-USER']['firstname'] . $_SESSION['ADMIN-USER']['name'], $_SESSION['ADMIN-USER']['mail'],
                    $_POST['input_mail'], $_POST['subject'])) {
                        ...
                        if (isset($_GET['action']) && $_GET['action'] === 'form') {
                            if ((isset($_GET['id']) && $_GET['id'] == $_SESSION['ADMIN-USER']['id']) || (isset($_GET['id']) && $_SESSION['ADMIN-USER']['statut'] == 1)) {
                                ...
                                if (empty($item)) {
                                    ...
                                    if ($_SESSION['ADMIN-USER']['statut'] === $item->statut && $_SESSION['ADMIN-USER']['id'] !== $item->id) {
                             ...
                             **    APPEL TOOLS                                                **
                             **************************************************************/
                            $toolsToLoad = ["bootstrap-css", "jquery", "bootstrap-js", "admin-script"];
                            $stylesToLoad = ["style"];
                            ...
                            if ((!isset($_GET['action']) && !isset($_POST['action'])) || (isset($_GET['action']) && $_GET['action'] === 'list')) {
                                 ...
                                 **    APPEL TOOLS                                                **
                                 **************************************************************/
                                $toolsToLoad = ["bootstrap-css", "jquery", "bootstrap-js", "admin-script", "datatable-css", "datatable-js"];
                                $stylesToLoad = ["style"];
                                ...
                                if (isset($_POST['action']) && $_POST['action'] === 'ajax_display_admin_fiche') {
                                    ...
                                    if (isset($_POST['action']) && $_POST['action'] === 'ajax_delete_avatar') {
                                        ...
                                        if (isset($_POST['action']) && $_POST['action'] === 'ajax_update_password') {
                                            ...
                                            if (isset($_POST['action']) && $_POST['action'] == 'uploadAjax') {
                                                ...
                                                if (isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
                                                    ...
                                                    if ($image_res) {
                                                        ...
                                                        if ($this->normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size,
                                                            $image_width, $image_height, $jpeg_quality)) {
                                                            //call crop_image_square() function to create square thumbnails
                                                            if (!$this->crop_image_square($image_res, $thumb_save_folder, $image_type,
